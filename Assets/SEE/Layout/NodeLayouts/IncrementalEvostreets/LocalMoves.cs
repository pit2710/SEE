...
using static SEE.Layout.NodeLayouts.IncrementalEvostreets.Direction;
...
namespace SEE.Layout.NodeLayouts.IncrementalEvostreets
{
    ...
    internal static class LocalMoves
    {
        ...
        public static void LocalMovesSearch(List<Node> nodes, IncrementalEvostreetsAttributes settings)
        {
